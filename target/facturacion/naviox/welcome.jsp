...
In facturacion-labels_en.properties:
facturacion=My application
facturacion[description]=My application does this and that

In facturacion-messages_en.properties:
